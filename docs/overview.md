...
<!--
If you prefer to use browser-ready bundle, use the following
script. The `cre` become globally available.
```html
<script type="text/javascript" src="con-reg-exp.js"></script>
```
-->
